...
define( 'SB_LIVE_WIDGETS_URL', 'http://angularph.com/' );

require_once( 'includes/Sb_Live_Widget.php' );

// register plugin settings page in admin menu
add_action( 'admin_menu', 'sb_live_widgets_add_menu_item' );

// register the widget
add_action( 'widgets_init', 'Sb_Live_Events::register_this_widget' );

// Register plugin styles and scripts in admin header
add_action( 'admin_enqueue_scripts', 'sb_live_events_widgets_admin_register_head' );


add_action( 'admin_init', 'sb_live_widgets_init' );
 ...
 */
function sb_live_events_widgets_admin_register_head() {
 ...
 */
function sb_live_widgets_add_menu_item() {
    /*
    add_submenu_page(
        'options-general.php',
    ...
    */
    add_options_page(
        'SB Live Events Settings',
        'SB Live Events',
        'manage_options',
        'sb-live-events',
        'sb_live_events_widgets_admin_page'
    );
}

function sb_live_widgets_init(){
    register_setting('sb-live-events-group', 'endpoint_name');
    register_setting('sb-live-events-group', 'number_of_events');
}
/**
 * Controller that generates and handles admin page
 */
function sb_live_events_widgets_admin_page() {
    /*
